...
open class BootstrapTask : DefaultTask() {
    ...
    private fun getBootstrap(): JSONArray? {
        ...
        val url = "https://raw.githubusercontent.com/tumri/oosrs-plugins/master/plugins.json"
        ...
        if (project == project.rootProject) {
            ...
            project.subprojects.forEach {
                if (it.project.properties.containsKey("PluginName") && it.project.properties.containsKey("PluginDescription")) {
                    ...
                    val releaseUrl = "https://github.com/tumri/oosrs-plugins/blob/master/release/${it.project.name}-${it.project.version}.jar?raw=true"
                    ...
                    val pluginProvider = "OpenOSRS"
                    val pluginProjectUrl = "https://discord.gg/OpenOSRS"
